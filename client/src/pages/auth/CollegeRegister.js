    ...
    try {
      ...
      if (response.user) {
        if (formData.role === 'new_university') {
          ...
          if (formData.role === 'new_university') {
            toast.success('Registration successful! Your university has been created.');
          } else {
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <Link to="/" className="flex flex-col items-center justify-center hover:opacity-80 transition-opacity">
            ...
            <p className="text-sm text-gray-600 mt-2">College Registration</p>
          </Link>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <input
                  ...
                  className={`mt-1 appearance-none relative block w-full px-3 py-2 border ${errors.firstName ? 'border-red-300' : 'border-gray-300'
                    } placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-[#138808] focus:border-[#138808] sm:text-sm`}
            ...
            <div>
              ...
              <select
                ...
                className={`mt-1 block w-full px-3 py-2 border ${errors.role ? 'border-red-300' : 'border-gray-300'
                  } bg-white rounded-md shadow-sm focus:outline-none focus:ring-[#138808] focus:border-[#138808] sm:text-sm`}
              >
            ...
            {!showNewOrgFields && formData.role && formData.role !== 'admin' && (
              <div>
                ...
                {getFilteredOrganizations().length === 0 && (
                  <p className="mt-1 text-sm text-gray-500">No colleges available. Please register a new college.</p>
                )}
              </div>
            )}
              ...
              <div className="space-y-4 p-4 bg-gray-50 rounded-md border border-gray-200">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-[#138808] focus:border-[#138808] sm:text-sm"
          ...
          <div>
            <button
              type="submit"
              className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#138808] hover:bg-[#0f6b0f] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#138808]"
            >
              Create Account
            </button>
          </div>
